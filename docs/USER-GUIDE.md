...
deadline lands on a weekend. That holds everywhere the bot writes a date: the weekly digest, alert
cards, the source scan, the spam report, a snooze confirmation ("back on Thu 2026-10-15"), and the
Jira issues it files. Give it a date of your own and it will label that one too.
